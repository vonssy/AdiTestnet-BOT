...
[![GitHub Stars](https://img.shields.io/github/stars/vonssy/AdiTestnet-BOT.svg)](https://github.com/vonssy/AdiTestnet-BOT/stargazers)
...
- 📦 **Transfer ADI** - Automated transfer ADI to random recepient
- 🔓 **Bridge ADI to Sepolia** - Automated bridge ADI to Sepolia
- 🎲 **Bridge Sepolia to ADI** - Automated bridge Sepolia to ADI
...
- **Test Token:** ADI & Sepolia ETH Faucet
...
```bash
git clone https://github.com/vonssy/AdiTestnet-BOT.git
cd AdiTestnet-BOT
```
...
- **Developer:** vonssy
- **Issues:** [GitHub Issues](https://github.com/vonssy/AdiTestnet-BOT/issues)
- **Discussions:** [GitHub Discussions](https://github.com/vonssy/AdiTestnet-BOT/discussions)
...
*Thank you for using Adi Testnet BOT! Don't forget to ⭐ star this repository.*
